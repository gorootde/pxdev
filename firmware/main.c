...
#
# Copyright (C) 2014 Tobias Gall, Christian Strobel
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//+++++					PiXtend Firmware 								+++++
//+++++					ATmega32A, Hardware: V1.2, Software: 1.2.5 		+++++
//+++++												           			+++++
//+++++					04. November 2015           					+++++
//+++++												           			+++++
...
int main(void) 
{
	...
	DDRD = 0b11000000;						//DIs Pin 0-3: Input, PWM Pins 4-5: Inputs, DOs Pin 6-7: Output
	...
	PORTD = 0b00110000; //activate internal pull-ups for PWM0/PWM1 Pins
	...
	if(PIND & 0b00100000)
	{
		//jumper isn't set --> PWM0- (PD5) and DO4-Pin (PD7) can be used as outputs
		PORTD &= ~(1<<PD5);
		DDRD |= (1<<PD5);
